...
class ViewModelProvider<TViewModel extends ViewModel> extends InheritedWidget {
  ...
  ViewModelProvider({Key? key, required TViewModel viewModel, required WidgetBuilder childBuilder}) : this._default(viewModel: viewModel, childBuilder: childBuilder);
...
class ViewModelViewStateManager extends StatefulWidget {
  ...
  ViewModelViewStateManager({Key? key, required ViewModel viewModel, required WidgetBuilder childBuilder})
      : assert(viewModel != null),
        assert(childBuilder != null),
